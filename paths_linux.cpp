...
fs::path getOutPath([[maybe_unused]] fs::path hdPath) {
  std::stringstream registry(dump_wine_registry(R"(HKEY_LOCAL_MACHINE\Software\Microsoft\DirectPlay\Applications\Age of Empires II - The Conquerors Expansion\)"));
  std::string winepath;
